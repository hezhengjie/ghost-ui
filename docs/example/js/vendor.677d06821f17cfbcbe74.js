...
var config = ({
   ...
   */
  productionTip: undefined.NODE_ENV !== 'production',

  /**
   * Whether to enable devtools
   */
  devtools: undefined.NODE_ENV !== 'production',
...
if (undefined.NODE_ENV !== 'production') {
...
Dep.prototype.notify = function notify () {
  ...
  if (undefined.NODE_ENV !== 'production' && !config.async) {
...
function defineReactive$$1 (
  ...
  Object.defineProperty(obj, key, {
    ...
    set: function reactiveSetter (newVal) {
      ...
      if (undefined.NODE_ENV !== 'production' && customSetter) {
        customSetter();
      }
...
function set (target, key, val) {
  ...
  if (target._isVue || (ob && ob.vmCount)) {
    undefined.NODE_ENV !== 'production' && warn(
...
function mergeAssets (
  ...
  if (childVal) {
    undefined.NODE_ENV !== 'production' && assertObjectType(key, childVal, vm);
...
strats.computed = function (
  ...
  if (childVal && undefined.NODE_ENV !== 'production') {
    assertObjectType(key, childVal, vm);
  }
  if (!parentVal) { return childVal }
  ...
  if (Array.isArray(props)) {
    ...
    while (i--) {
      ...
      if (typeof val === 'string') {
        name = camelize(val);
        res[name] = { type: null };
      } else if (undefined.NODE_ENV !== 'production') {
...
function resolveAsset (
  ...
  if (undefined.NODE_ENV !== 'production' && warnMissing && !res) {
    warn(
...
function getPropDefaultValue (vm, prop, key) {
  ...
  if (undefined.NODE_ENV !== 'production' && isObject(def)) {
    warn(
...
function mountComponent (
  ...
  var updateComponent;
  /* istanbul ignore if */
  if (undefined.NODE_ENV !== 'production' && config.performance && mark) {
...
function flushSchedulerQueue () {
  ...
  for (index = 0; index < queue.length; index++) {
    ...
    if (undefined.NODE_ENV !== 'production' && has[id] != null) {
...
var Watcher = function Watcher (
  ...
  this.expression = undefined.NODE_ENV !== 'production'
    ? expOrFn.toString()
    : '';
...
function initComputed (vm, computed) {
  ...
  for (var key in computed) {
    ...
    if (undefined.NODE_ENV !== 'production' && getter == null) {
      warn(
...
function renderSlot (
  ...
  if (scopedSlotFn) { // scoped slot
    props = props || {};
    if (bindObject) {
      if (undefined.NODE_ENV !== 'production' && !isObject(bindObject)) {
        warn(
...
function renderMixin (Vue) {
  ...
  Vue.prototype._render = function () {
    ...
    try {
      ...
      /* istanbul ignore else */
      if (undefined.NODE_ENV !== 'production' && vm.$options.renderError) {
        try {
    ...
    if (!(vnode instanceof VNode)) {
      if (undefined.NODE_ENV !== 'production' && Array.isArray(vnode)) {
        warn(
...
function initExtend (Vue) {
  ...
  Vue.extend = function (extendOptions) {
    ...
    if (undefined.NODE_ENV !== 'production' && name) {
  ...
  ASSET_TYPES.forEach(function (type) {
    Vue[type] = function (
      ...
      if (!definition) {
        ...
        /* istanbul ignore if */
        if (undefined.NODE_ENV !== 'production' && type === 'component') {
...
function createPatchFunction (backend) {
  ...
  function createElm (
    ...
    if (isDef(tag)) {
      ...
      if (undefined.NODE_ENV !== 'production' && data && data.pre) {
        creatingElmInVPre--;
      }
...
function enter (vnode, toggleDisplay) {
  ...
  if (undefined.NODE_ENV !== 'production' && explicitEnterDuration != null) {
...
function leave (vnode, rm) {
  ...
  if (undefined.NODE_ENV !== 'production' && isDef(explicitLeaveDuration)) {
...
var Transition = {
  ...
  render: function render (h) {
    ...
    if (undefined.NODE_ENV !== 'production' && children.length > 1) {
      warn(
...
function warn (condition, message) {
  if (undefined.NODE_ENV !== 'production' && !condition) {
...
function resolveQuery (
  ...
  try {
    ...
    undefined.NODE_ENV !== 'production' && warn(false, e.message);
    parsedQuery = {};
  }
...
function addRouteRecord (
  ...
  if (name) {
    if (!nameMap[name]) {
      nameMap[name] = record;
    } else if (undefined.NODE_ENV !== 'production' && !matchAs) {
      warn(
        false,
    ...
    flatMapComponents(matched, function (def, _, match, key) {
      ...
      if (typeof def === 'function' && def.cid === undefined) {
        ...
        var reject = once(function (reason) {
          ...
          undefined.NODE_ENV !== 'production' && warn(false, msg);
          if (!error) {
...
VueRouter.prototype.init = function init (app /* Vue component instance */) {
  ...
  undefined.NODE_ENV !== 'production' && assert(
    install.installed,
